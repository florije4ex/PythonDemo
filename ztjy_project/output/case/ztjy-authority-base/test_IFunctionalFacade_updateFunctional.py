...
class Test_IFunctionalFacade_updateFunctional(object):
    def setup_class(self):
        self._ifunctionalfacade = IFunctionalFacade()

    @pytest.mark.parametrize('functional, operateUserId, userCenterEnum', pairs_datas())
    def test_IFunctionalFacade_updateFunctional(self, functional, operateUserId, userCenterEnum):
        ...
        try:
            result = self._ifunctionalfacade.updateFunctional(params=params)
