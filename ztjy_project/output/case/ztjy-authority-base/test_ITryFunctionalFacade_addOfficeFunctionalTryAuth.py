...
class Test_ITryFunctionalFacade_addOfficeFunctionalTryAuth(object):
    ...
    def test_ITryFunctionalFacade_addOfficeFunctionalTryAuth(self, officeId, functionalCodes, operateUserId, userCenterEnum):
        ...
        try:
            result = self._itryfunctionalfacade.addOfficeFunctionalTryAuth(params=params)
