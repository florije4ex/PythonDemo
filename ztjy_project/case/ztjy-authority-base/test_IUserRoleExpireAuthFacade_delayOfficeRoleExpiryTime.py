...
class Test_IUserRoleExpireAuthFacade_delayOfficeRoleExpiryTime(object):
    def setup_class(self):
        self._iuserroleexpireauthfacade = IUserRoleExpireAuthFacade()

    @pytest.mark.parametrize('['userRoleOprerateDTO']', '')
    def test_IUserRoleExpireAuthFacade_delayOfficeRoleExpiryTime(self, userRoleOprerateDTO):
        params = self._iuserroleexpireauthfacade.generator_params(userRoleOprerateDTO=userRoleOprerateDTO)
        try:
            result = self._iuserroleexpireauthfacade.delayOfficeRoleExpiryTime(params=params)
