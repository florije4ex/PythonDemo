...
class Test_IFunctionalFacade_findModuleFunctional(object):
    def setup_class(self):
        self._ifunctionalfacade = IFunctionalFacade()

    @pytest.mark.parametrize('[]', '')
    def test_IFunctionalFacade_findModuleFunctional(self, ):
        params = self._ifunctionalfacade.generator_params()
        try:
            result = self._ifunctionalfacade.findModuleFunctional(params=params)
