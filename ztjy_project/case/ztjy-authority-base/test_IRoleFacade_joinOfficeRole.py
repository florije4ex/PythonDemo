...
class Test_IRoleFacade_joinOfficeRole(object):
    ...
    def test_IRoleFacade_joinOfficeRole(self, userId, operateUserId, userType, officeId, roleId, systemType):
        ...
        try:
            result = self._irolefacade.joinOfficeRole(params=params)
