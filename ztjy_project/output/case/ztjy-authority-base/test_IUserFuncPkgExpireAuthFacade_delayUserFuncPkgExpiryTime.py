...
class Test_IUserFuncPkgExpireAuthFacade_delayUserFuncPkgExpiryTime(object):
    ...
    def test_IUserFuncPkgExpireAuthFacade_delayUserFuncPkgExpiryTime(self, userFunctionalPackageOprerateDTO):
        ...
        try:
            result = self._iuserfuncpkgexpireauthfacade.delayUserFuncPkgExpiryTime(params=params)
