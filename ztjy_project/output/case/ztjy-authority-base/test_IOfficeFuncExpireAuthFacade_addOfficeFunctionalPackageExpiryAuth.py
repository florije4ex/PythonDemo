...
class Test_IOfficeFuncExpireAuthFacade_addOfficeFunctionalPackageExpiryAuth(object):
    ...
    def test_IOfficeFuncExpireAuthFacade_addOfficeFunctionalPackageExpiryAuth(self, officeFunctionalPackageOprerateDTO):
        ...
        try:
            result = self._iofficefuncexpireauthfacade.addOfficeFunctionalPackageExpiryAuth(params=params)
