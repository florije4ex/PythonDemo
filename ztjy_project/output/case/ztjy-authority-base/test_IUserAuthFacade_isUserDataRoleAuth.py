...
class Test_IUserAuthFacade_isUserDataRoleAuth(object):
    def setup_class(self):
        self._iuserauthfacade = IUserAuthFacade()

    @pytest.mark.parametrize('userId, dataCode, userTypeEnum, officeId', pairs_datas())
    def test_IUserAuthFacade_isUserDataRoleAuth(self, userId, dataCode, userTypeEnum, officeId):
        ...
        try:
            result = self._iuserauthfacade.isUserDataRoleAuth(params=params)
