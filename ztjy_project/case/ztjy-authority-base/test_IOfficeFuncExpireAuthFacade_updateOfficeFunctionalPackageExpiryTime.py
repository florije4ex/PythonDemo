...
class Test_IOfficeFuncExpireAuthFacade_updateOfficeFunctionalPackageExpiryTime(object):
    ...
    def test_IOfficeFuncExpireAuthFacade_updateOfficeFunctionalPackageExpiryTime(self, officeFunctionalPackageOprerateDTO):
        ...
        try:
            result = self._iofficefuncexpireauthfacade.updateOfficeFunctionalPackageExpiryTime(params=params)
