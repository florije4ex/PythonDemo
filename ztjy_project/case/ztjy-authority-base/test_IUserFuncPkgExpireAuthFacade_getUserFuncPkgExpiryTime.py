...
class Test_IUserFuncPkgExpireAuthFacade_getUserFuncPkgExpiryTime(object):
    def setup_class(self):
        self._iuserfuncpkgexpireauthfacade = IUserFuncPkgExpireAuthFacade()

    @pytest.mark.parametrize('functionalPackageCode, userId, officeId, userTypeEnum', pairs_datas())
    def test_IUserFuncPkgExpireAuthFacade_getUserFuncPkgExpiryTime(self, functionalPackageCode, userId, officeId, userTypeEnum):
        params = self._iuserfuncpkgexpireauthfacade.generator_params(functionalPackageCode=functionalPackageCode, userId=userId, officeId=officeId, userTypeEnum=userTypeEnum)
        try:
            result = self._iuserfuncpkgexpireauthfacade.getUserFuncPkgExpiryTime(params=params)
