...
class Test_IDataAuthFacade_getAllDataModel(object):
    def setup_class(self):
        self._idataauthfacade = IDataAuthFacade()

    @pytest.mark.parametrize('[]', '')
    def test_IDataAuthFacade_getAllDataModel(self, ):
        params = self._idataauthfacade.generator_params()
        try:
            result = self._idataauthfacade.getAllDataModel(params=params)
