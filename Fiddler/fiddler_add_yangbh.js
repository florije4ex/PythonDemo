...
class Handlers
{
    ...
    */
    ...
    static function OnBeforeRequest(oSession: Session) {
		...
		//var requestString = '"studentId":"1e83bba94139a4d152e9"' //Android 65029f8c4b4405a835f3   IOS 1e83bba94139a4d152e9
		//var requestReplaceString = '"studentId":"65029f8c4b4405a835fe"'

		//oSession.utilReplaceInRequest(requestString,requestReplaceString);



        if (oSession.uriContains(".szy.com")) {	oSession["ui-color"] = "blue";oSession["ui-bold"]="QuickExec"; }
        if (oSession.uriContains(".szy.cn")) {	oSession["ui-color"] = "green";	oSession["ui-bold"]="QuickExec"; }
