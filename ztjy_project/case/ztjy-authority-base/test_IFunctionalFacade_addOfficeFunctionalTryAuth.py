...
class Test_IFunctionalFacade_addOfficeFunctionalTryAuth(object):
    ...
    def test_IFunctionalFacade_addOfficeFunctionalTryAuth(self, officeId, functionalCodes, operateUserId, userCenterEnum):
        ...
        try:
            result = self._ifunctionalfacade.addOfficeFunctionalTryAuth(params=params)
