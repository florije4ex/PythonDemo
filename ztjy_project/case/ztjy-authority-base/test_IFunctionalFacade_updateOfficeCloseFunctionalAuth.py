...
class Test_IFunctionalFacade_updateOfficeCloseFunctionalAuth(object):
    ...
    def test_IFunctionalFacade_updateOfficeCloseFunctionalAuth(self, officeId, functionalCodes, operateUserId, userCenterEnum):
        params = self._ifunctionalfacade.generator_params(officeId=officeId, functionalCodes=functionalCodes, operateUserId=operateUserId, userCenterEnum=userCenterEnum)
        try:
            result = self._ifunctionalfacade.updateOfficeCloseFunctionalAuth(params=params)
