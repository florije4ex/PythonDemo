...
class Test_IFunctionalFacade_deleteOfficeFunctionalTryAuth(object):
    ...
    def test_IFunctionalFacade_deleteOfficeFunctionalTryAuth(self, officeId, functionalCodes, operateUserId, userCenterEnum):
        ...
        try:
            result = self._ifunctionalfacade.deleteOfficeFunctionalTryAuth(params=params)
