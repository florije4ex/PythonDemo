...
class Test_IFunctionalFacade_addOfficeFunctionalPackageAuth(object):
    ...
    def test_IFunctionalFacade_addOfficeFunctionalPackageAuth(self, officeId, functionalPackageCode, operateUserId, userCenterEnum):
        ...
        try:
            result = self._ifunctionalfacade.addOfficeFunctionalPackageAuth(params=params)
